...
if __name__ == "__main__":
    ...
    #
    # print("DFRESULT1")
    # print(df_result[df_result.Gene_Id.notnull()][["Organism Name", "Gene_Id", "Nucleotide_Id", "Fasta_Seq"]])
    #
    # print("DFRESULT2")
    # print(df_result[df_result.Nucleotide_Id.notnull()][["Organism Name", "Gene_Id", "Nucleotide_Id", "Fasta_Seq"]])
    #
    # print("DFRESULT3")
    # print(df_result[df_result.Fasta_Seq.notnull()][["Organism Name", "Gene_Id", "Nucleotide_Id", "Fasta_Seq"]])

    print("DFRESULT4")
    print(df_result[df_result.GC_Fasta_Seq.notnull()][["Organism Name", "Gene_Id", "Nucleotide_Id", "Fasta_Seq"]])
